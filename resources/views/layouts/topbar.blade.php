<div class="topbar">
                    ...
                    <div class="tab-pane active show p-8" id="topbar_notifications_notifications" role="tabpanel">
                        ...
                        <div class="scroll pr-7 mr-n7" data-scroll="true" data-height="300" data-mobile-height="200">
                            ...
                            <div class="d-flex align-items-center mb-6">
                                ...
                                <!--begin::Text-->
                                <div class="d-flex flex-column font-weight-bold">
                                    <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg">Diana</a>
                            ...
                            <div class="d-flex align-items-center mb-6">
                                ...
                                <!--begin::Text-->
                                <div class="d-flex flex-column font-weight-bold">
                                    <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">yannah</a>
                            ...
                            <div class="d-flex align-items-center mb-6">
                                ...
                                <!--begin::Text-->
                                <div class="d-flex flex-column font-weight-bold">
                                    <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">RAMOS</a>
                            ...
                            <div class="d-flex align-items-center mb-6">
                                ...
                                <!--begin::Text-->
                                <div class="d-flex flex-column font-weight-bold">
                                    <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">DIANA</a>
            ...
            <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                <span class="svg-icon svg-icon-xl svg-icon-primary">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <rect x="0" y="0" width="24" height="24" />
                            <rect fill="#808080" opacity="0.3" x="13" y="4" width="3" height="16" rx="1.5" />
                            <rect fill="#808080" x="8" y="9" width="3" height="11" rx="1.5" />
                            <rect fill="#808080" x="18" y="11" width="3" height="9" rx="1.5" />
                            <rect fill="#808080" x="3" y="13" width="3" height="7" rx="1.5" />
                        </g>
                    </svg>
                    <!--end::Svg Icon-->
                </span>
        ...
        <div class="btn btn-icon btn-clean btn-lg mr-1" id="kt_quick_panel_toggle">
            <span class="svg-icon svg-icon-xl svg-icon-primary">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <rect x="0" y="0" width="24" height="24" />
                        <rect fill="#808080" x="4" y="4" width="7" height="7" rx="1.5" />
        ...
        <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
            ...
            <ul class="navi navi-hover py-4">
                ...
                <li class="navi-item">
                    <a href="#" class="navi-link">
                        <span class="symbol symbol-20 mr-3">
                            <img src="assets/media/users/101.jpg.jpg" alt="" />
                        </span>
                ...
                <li class="navi-item">
                    <a href="#" class="navi-link">
                        <span class="symbol symbol-20 mr-3">
                            <img src="public/assets/media/users/101.jpg.jpg" alt="" />
                        </span>
    ...
    <div class="topbar-item">
        <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
            ...
            <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">Diana</span>
